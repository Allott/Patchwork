...
namespace Patchwork
{
    class PlayerAgentPointPerTimeReactive : Player
    {
        public PlayerAgentPointPerTimeReactive(string nam) : base(nam)
        {
        }

        public PlayerAgentPointPerTimeReactive(Player p) : base(p)
        {
        }
        public override string Turn(Game current)
        {
            ...
            PlayerAgentPointPerTimeReactive oppC = new PlayerAgentPointPerTimeReactive(current.ReturnOpponent(this.GetName()));//get opponent
